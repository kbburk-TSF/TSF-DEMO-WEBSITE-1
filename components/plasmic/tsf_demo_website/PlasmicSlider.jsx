...
import sty from "./PlasmicSlider.module.css"; // plasmic-import: eyDnbTMh6R0P/css
  ...
  return (
    ...
    >
      {$props.showLabel || $props.showOutputText ? (
        <div className={classNames(projectcss.all, sty.freeBox__trOAx)}>
          {$props.showLabel ? (
            <Label
      ...
      <div className={classNames(projectcss.all, sty.freeBox__pd5Rr)}>
        <div
