...
import sty from "./PlasmicCheckboxGroup.module.css"; // plasmic-import: 4ds0MKNHjk7p/css
...
function PlasmicCheckboxGroup__RenderFunc(props) {
  ...
  return (
    ...
    >
      ...
      {renderPlasmicSlot({
        defaultContents: (
          <div className={classNames(projectcss.all, sty.freeBox__ecbFb)}>
            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__bN5)}
              label={"Option 1"}
              value={"option1"}
            />

            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__ljkBd)}
              label={"Option 2"}
              value={"option2"}
            />

            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__qNwac)}
              label={"Option 3"}
              value={"option3"}
            />
          </div>
