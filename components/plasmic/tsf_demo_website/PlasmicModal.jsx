...
import sty from "./PlasmicModal.module.css"; // plasmic-import: _SoMFz68WlLD/css
    ...
    <BaseDialogTrigger
      ...
      dialog={
        <BaseModal
          ...
          modalOverlayClass={classNames({ [sty["pcls_bsWBRb2tbrsG"]]: true })}
          ...
          >
            ...
            >
              {renderPlasmicSlot({
                defaultContents: (
                  <div
                    className={classNames(projectcss.all, sty.freeBox__scsmI)}
                  >
                    <div
                      className={classNames(
                        projectcss.all,
            ...
            {renderPlasmicSlot({
              defaultContents: (
                <div
                  className={classNames(projectcss.all, sty.freeBox___6H4Rm)}
                >
                  <Button
                    color={"muted"}
                    label={
