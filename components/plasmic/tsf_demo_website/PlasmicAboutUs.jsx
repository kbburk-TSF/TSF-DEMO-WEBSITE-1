...
import sty from "./PlasmicAboutUs.module.css"; // plasmic-import: v7HjjdvUMTSh/css
import ArrowRightSvgIcon from "./icons/PlasmicIcon__ArrowRightSvg"; // plasmic-import: 1kxlB7-_4TS7/icon
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: 5oXM7zfN_tkR/icon
    ...
    <React.Fragment>
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          ...
          >
            <div className={classNames(projectcss.all, sty.freeBox__tNjQb)}>
              <div
                data-plasmic-name={"columns"}
                data-plasmic-override={overrides.columns}
                className={classNames(projectcss.all, sty.columns)}
              >
                <div className={classNames(projectcss.all, sty.column__nqZ8A)}>
                  <div
                    className={classNames(projectcss.all, sty.freeBox__nnLfy)}
                  >
                    <h1
                ...
                <div className={classNames(projectcss.all, sty.column__vcsWi)}>
                  <PlasmicImg__
                    alt={""}
                    className={classNames(sty.img__lRY)}
                    displayHeight={"auto"}
          ...
          <div className={classNames(projectcss.all, sty.freeBox__scMPs)}>
            <section
              data-plasmic-name={"features"}
              data-plasmic-override={overrides.features}
              className={classNames(projectcss.all, sty.features)}
            >
              <div className={classNames(projectcss.all, sty.column__wueOr)}>
                <h2
                  className={classNames(
                    projectcss.all,
                    projectcss.h2,
                ...
                >
                  ...
                  >
                    ...
                    >
                      <div
                        className={classNames(projectcss.all, sty.column__zpBs)}
                      >
                        <div
                          className={classNames(
                            projectcss.all,
                      ...
                      >
                        <PlasmicImg__
                          alt={""}
                          className={classNames(sty.img__s9TGi)}
                          displayHeight={"400px"}
                          displayMaxHeight={"none"}
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <PlasmicImg__
                          alt={""}
                          className={classNames(sty.img__hTuqP)}
                          displayHeight={"auto"}
                          displayMaxHeight={"none"}
                          displayMaxWidth={
                            hasVariant(globalVariants, "screen", "mobileOnly")
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <PlasmicImg__
                          alt={""}
                          className={classNames(sty.img__f7O8H)}
                          displayHeight={"400px"}
                          displayMaxHeight={"none"}
                          displayMaxWidth={"none"}
                          displayMinHeight={"0"}
