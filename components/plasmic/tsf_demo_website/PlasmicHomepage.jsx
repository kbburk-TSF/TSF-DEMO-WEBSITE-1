...
import BlogPosts from "../../BlogPosts"; // plasmic-import: JgQp-A5r4upv/component
import CtaBlock from "../../CtaBlock"; // plasmic-import: z8-igd85F87t/component
...
import sty from "./PlasmicHomepage.module.css"; // plasmic-import: T9ZuXXNpmJiI/css
  ...
  return (
    <React.Fragment>
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          <div className={classNames(projectcss.all, sty.freeBox__qflMf)}>
            <Header
            ...
            <div className={classNames(projectcss.all, sty.freeBox__jk9G0)}>
              <div className={classNames(projectcss.all, sty.freeBox___5MPir)}>
                <div className={classNames(projectcss.all, sty.freeBox__u7NAq)}>
                  <div
                    className={classNames(projectcss.all, sty.freeBox__frig7)}
                  >
                    <div
                      className={classNames(projectcss.all, sty.freeBox__owzI3)}
                    >
                      <h1
                        className={classNames(
                          projectcss.all,
                  ...
                  <div
                    className={classNames(projectcss.all, sty.freeBox___3JFAj)}
                  >
                    <PlasmicImg__
                      alt={""}
                      className={classNames(sty.img__iCeiZ)}
                      displayHeight={"auto"}
          ...
          >
            <div className={classNames(projectcss.all, sty.column__v4OBn)}>
              <h1
                className={classNames(
                  projectcss.all,
                  projectcss.h1,
              ...
              <PlasmicImg__
                alt={""}
                className={classNames(sty.img__bsPOr)}
                displayHeight={"auto"}
                displayMaxHeight={"none"}
                displayMaxWidth={"100%"}
                displayMinHeight={"0"}
              ...
              <PlasmicImg__
                alt={""}
                className={classNames(sty.img__eqFnk)}
                displayHeight={"auto"}
                displayMaxHeight={"none"}
                displayMaxWidth={"100%"}
                displayMinHeight={"0"}
              ...
              <PlasmicImg__
                alt={""}
                className={classNames(sty.img__sXcAg)}
                displayHeight={"auto"}
                displayMaxHeight={"none"}
                displayMaxWidth={"100%"}
                displayMinHeight={"0"}
              ...
              >
                <div className={classNames(projectcss.all, sty.column__fi4Un)}>
                  <h1
                    className={classNames(
                      projectcss.all,
                      projectcss.h1,
                  ...
                  <Button
                    className={classNames("__wab_instance", sty.button__ioRFp)}
                    color={"muted"}
                    label={
                      <div
                        className={classNames(
                ...
                <div className={classNames(projectcss.all, sty.column__hfwBg)}>
                  <h1
                    className={classNames(
                      projectcss.all,
                      projectcss.h1,
                  ...
                  <Button
                    className={classNames("__wab_instance", sty.button__zqgHi)}
                    color={"muted"}
                    label={
                      <div
                        className={classNames(
                ...
                <div className={classNames(projectcss.all, sty.column__hl80H)}>
                  <h1
                    className={classNames(
                      projectcss.all,
                      projectcss.h1,
                  ...
                  <Button
                    className={classNames("__wab_instance", sty.button__zdf6P)}
                    color={"muted"}
                    label={
                      <div
                        className={classNames(
