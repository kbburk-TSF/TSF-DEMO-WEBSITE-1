...
import sty from "./PlasmicMenuPopover.module.css"; // plasmic-import: 9UKjHsI0ypiR/css
            ...
            {renderPlasmicSlot({
              defaultContents: (
                <React.Fragment>
                  ...
                  <MenuItem
                    className={classNames("__wab_instance", sty.menuItem__puvn)}
                    label={"Item 3"}
                    value={"item3"}
                  />
