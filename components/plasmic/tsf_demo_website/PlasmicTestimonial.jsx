...
import sty from "./PlasmicTestimonial.module.css"; // plasmic-import: 3LLozVQ2ppLR/css
...
function PlasmicTestimonial__RenderFunc(props) {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.column__t8RXu)}>
        <h2
        ...
        >
          <div className={classNames(projectcss.all, sty.column__zPzHn)}>
            <PlasmicImg__
          ...
          <div className={classNames(projectcss.all, sty.column__v23K4)}>
            <h5
