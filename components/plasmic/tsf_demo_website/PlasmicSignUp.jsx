...
import sty from "./PlasmicSignUp.module.css"; // plasmic-import: Abao4wmW_zbz/css
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          ...
          >
            ...
            >
              <div className={classNames(projectcss.all, sty.freeBox__oVud3)}>
                <div
                  className={classNames(projectcss.all, sty.columns___55Y0O)}
                >
                  <div
                    className={classNames(projectcss.all, sty.column__tUgVl)}
                  >
                    <div
                      className={classNames(projectcss.all, sty.freeBox__poheF)}
                    >
                      <h1
                  ...
                  <div
                    className={classNames(projectcss.all, sty.column__igckV)}
                  >
                    <PlasmicImg__
                      alt={""}
                      className={classNames(sty.img__tLjjV)}
                      displayHeight={"auto"}
            ...
            >
              <div className={classNames(projectcss.all, sty.columns__i05Em)}>
                <div className={classNames(projectcss.all, sty.column___4XdE3)}>
                  <form
                ...
                <div className={classNames(projectcss.all, sty.column__dRPf5)}>
                  <PlasmicImg__
                    alt={""}
                    className={classNames(sty.img__qBUnO)}
                    displayHeight={"100%"}
                    displayMaxHeight={"none"}
                    displayMaxWidth={"100%"}
                    displayMinHeight={"0"}
