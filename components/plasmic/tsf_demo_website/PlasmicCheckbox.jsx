...
import sty from "./PlasmicCheckbox.module.css"; // plasmic-import: yC_oCxtTQhAd/css
import CheckIcon from "./icons/PlasmicIcon__Check"; // plasmic-import: fjNo4gjamDCn/icon
import MinusIcon from "./icons/PlasmicIcon__Minus"; // plasmic-import: aZAmBKgXt8Up/icon
...
function PlasmicCheckbox__RenderFunc(props) {
  ...
  return (
    ...
    >
      ...
      >
        <CheckIcon
          className={classNames(projectcss.all, sty.svg__jrUiD)}
          role={"img"}
        />

        <MinusIcon
          className={classNames(projectcss.all, sty.svg__xHssN)}
          role={"img"}
        />
      </div>
      {renderPlasmicSlot({
