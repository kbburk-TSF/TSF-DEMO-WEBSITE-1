...
import Radio from "../../Radio"; // plasmic-import: 3YPIaD3a3Oaj/component
...
import sty from "./PlasmicRadioGroup.module.css"; // plasmic-import: 0CzLoJA5bp6Y/css
...
function PlasmicRadioGroup__RenderFunc(props) {
  ...
  return (
    ...
    >
      ...
      {renderPlasmicSlot({
        defaultContents: (
          <div className={classNames(projectcss.all, sty.freeBox___3VaNd)}>
            <Radio
              className={classNames("__wab_instance", sty.radio__pLAyK)}
              label={"Option 1"}
              value={"option1"}
            />

            <Radio
              className={classNames("__wab_instance", sty.radio___5WnJ)}
              label={"Option 2"}
              value={"option2"}
            />

            <Radio
              className={classNames("__wab_instance", sty.radio__xzeMe)}
              label={"Option 3"}
              value={"option3"}
            />
          </div>
