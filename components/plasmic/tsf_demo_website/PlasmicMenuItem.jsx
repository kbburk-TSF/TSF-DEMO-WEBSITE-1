...
import sty from "./PlasmicMenuItem.module.css"; // plasmic-import: lvXaTgD342E3/css
...
function PlasmicMenuItem__RenderFunc(props) {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__c1EYi)}>
        <BaseText
          ...
          slot={"label"}
        >
          <div className={classNames(projectcss.all, sty.freeBox__xAbmc)}>
            <div
              className={classNames(
                projectcss.all,
