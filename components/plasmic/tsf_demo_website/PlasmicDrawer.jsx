...
import sty from "./PlasmicDrawer.module.css"; // plasmic-import: eC0JW4oD3krq/css
    ...
    <BaseDialogTrigger
      ...
      dialog={
        <BaseModal
          ...
          modalOverlayClass={classNames({ [sty["pcls_w7G0oSRTfJd_"]]: true })}
        ...
        >
          ...
          >
            <div className={classNames(projectcss.all, sty.freeBox__hnGOa)}>
              {renderPlasmicSlot({
                defaultContents: (
                  <h2
                    className={classNames(
              ...
              >
                {renderPlasmicSlot({
                  defaultContents: (
                    <div
                      className={classNames(projectcss.all, sty.freeBox__wQlB)}
                    >
                      <div
                        className={classNames(
                          projectcss.all,
              ...
              <div className={classNames(projectcss.all, sty.freeBox___8C1V7)}>
                {renderPlasmicSlot({
                  defaultContents: (
                    <div
                      className={classNames(projectcss.all, sty.freeBox__vJukM)}
                    >
                      <Button
                        color={"muted"}
                        label={"Close"}
      ...
      trigger={
        (hasVariant($state, "noTrigger", "noTrigger") ? false : true)
          ? renderPlasmicSlot({
              defaultContents: (
                <Button
                  className={classNames("__wab_instance", sty.button__sMjVs)}
                  label={
                    <div
                      className={classNames(
                        projectcss.all,
