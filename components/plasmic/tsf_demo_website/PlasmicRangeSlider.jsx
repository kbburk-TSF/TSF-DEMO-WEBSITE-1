...
import SliderThumb from "../../SliderThumb"; // plasmic-import: lUiUKuAuj25p/component
...
import sty from "./PlasmicRangeSlider.module.css"; // plasmic-import: -mWuepJPZVJA/css
...
function PlasmicRangeSlider__RenderFunc(props) {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__sadi4)}>
        {$props.showLabel ? (
          <Label
      ...
      <div className={classNames(projectcss.all, sty.freeBox__k3VzY)}>
        <div
