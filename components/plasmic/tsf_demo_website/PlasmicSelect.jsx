...
import MenuPopover from "../../MenuPopover"; // plasmic-import: 9UKjHsI0ypiR/component
import MenuItem from "../../MenuItem"; // plasmic-import: lvXaTgD342E3/component
import MenuSection from "../../MenuSection"; // plasmic-import: -bh0mMHOsHd-/component
...
import sty from "./PlasmicSelect.module.css"; // plasmic-import: tAxB0oZ5LJ1-/css
        ...
        menuItems={renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              ...
              <MenuSection
                className={classNames("__wab_instance", sty.menuSection__tZ4Qa)}
                header={
                  <div
                    className={classNames(
                      projectcss.all,
