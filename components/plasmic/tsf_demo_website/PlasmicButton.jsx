...
import sty from "./PlasmicButton.module.css"; // plasmic-import: aP6avST_BW-8/css
import CircleIcon from "./icons/PlasmicIcon__Circle"; // plasmic-import: 8c4gjxZO5oTE/icon
import ChevronDownIcon from "./icons/PlasmicIcon__ChevronDown"; // plasmic-import: w97chA4KrwFr/icon
...
function PlasmicButton__RenderFunc(props) {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox___1WKho, {
          [sty.freeBoxcolor_neutral___1WKhOngCfJ]: hasVariant(
            $state,
            "color",
            "neutral"
          ),
          [sty.freeBoxcolor_success_type_bordered___1WKhoNvf28ItCvf]:
            hasVariant($state, "color", "success") &&
            hasVariant($state, "type", "bordered"),
          [sty.freeBoxroundedFull___1WKhoVthT]: hasVariant(
            $state,
            "roundedFull",
            "roundedFull"
          ),
          [sty.freeBoxsize_extraLarge___1WKhOiKnxX]: hasVariant(
            $state,
            "size",
            "extraLarge"
          ),
          [sty.freeBoxsize_extraSmall___1WKhoMrRa]: hasVariant(
            $state,
            "size",
            "extraSmall"
          ),
          [sty.freeBoxsize_large___1WKhogc6Pl]: hasVariant(
            $state,
            "size",
            "large"
          ),
          [sty.freeBoxsize_small___1WKho3Nuym]: hasVariant(
            $state,
            "size",
            "small"
          ),
          [sty.freeBoxtype_bordered___1WKhOitCvf]: hasVariant(
            $state,
            "type",
            "bordered"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__lNao0, {
            [sty.freeBoxcolor_neutral__lNao0NgCfJ]: hasVariant(
              $state,
              "color",
              "neutral"
            ),
            [sty.freeBoxiconStart__lNao0VaqHx]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxsize_extraLarge__lNao0IKnxX]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__lNao0Gc6Pl]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__lNao03Nuym]: hasVariant(
              $state,
              "size",
              "small"
            ),
            [sty.freeBoxtype_bordered__lNao0ItCvf]: hasVariant(
              $state,
              "type",
              "bordered"
            ),
            [sty.freeBoxtype_soft_color_neutral__lNao0Cbb2MNgCfJ]:
              hasVariant($state, "color", "neutral") &&
              hasVariant($state, "type", "soft")
          })}
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__gJe4U)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox___5Bsmf, {
            [sty.freeBoxiconEnd___5BsmFj7804]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxsize_extraLarge___5BsmFiKnxX]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large___5Bsmfgc6Pl]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small___5Bsmf3Nuym]: hasVariant(
              $state,
              "size",
              "small"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChevronDownIcon
                className={classNames(projectcss.all, sty.svg__hcz4X)}
                role={"img"}
              />
            ),
