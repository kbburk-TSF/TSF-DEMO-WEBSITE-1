...
import sty from "./PlasmicCtaBlock.module.css"; // plasmic-import: z8-igd85F87t/css
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div className={classNames(projectcss.all, sty.column__etsax)}>
            <h2
          ...
          <div className={classNames(projectcss.all, sty.column__wFfEx)}>
            <Button
