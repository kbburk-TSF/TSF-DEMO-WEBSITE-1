...
import Label from "../../Label"; // plasmic-import: Za8adaNTLREY/component
import TextInput from "../../TextInput"; // plasmic-import: qJo3aJuGfEeG/component
import TextAreaInput from "../../TextAreaInput"; // plasmic-import: HQYt7uZs-TJS/component
import Description from "../../Description"; // plasmic-import: PkYcxCZkAo1X/component
...
import sty from "./PlasmicTextField.module.css"; // plasmic-import: lmfHA9icPZkM/css
...
function PlasmicTextField__RenderFunc(props) {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__vgxR4, {
          [sty.freeBoxiconEnd__vgxR4VkZsC]: hasVariant(
            $state,
            "iconEnd",
            "iconEnd"
          ),
          [sty.freeBoxiconStart__vgxR4Zppso]: hasVariant(
            $state,
            "iconStart",
            "iconStart"
          ),
          [sty.freeBoxmultiLine__vgxR4JnCbU]: hasVariant(
            $state,
            "multiLine",
            "multiLine"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__sl18, {
            [sty.freeBoxiconStart__sl18Zppso]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxmultiLine__sl18JnCbU]: hasVariant(
              $state,
              "multiLine",
              "multiLine"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__kO9Ae)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__xwgvQ, {
            [sty.freeBoxiconEnd__xwgvQvkZsC]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxiconStart__xwgvQzppso]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__iEdDh)}
                role={"img"}
              />
            ),
