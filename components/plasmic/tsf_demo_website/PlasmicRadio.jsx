...
import sty from "./PlasmicRadio.module.css"; // plasmic-import: 3YPIaD3a3Oaj/css
...
function PlasmicRadio__RenderFunc(props) {
  ...
  return (
    <BaseRadio
      ...
      value={args.value}
    >
      <div className={classNames(projectcss.all, sty.freeBox___4F62)}>
        <div className={classNames(projectcss.all, sty.freeBox__ql0Da)} />
      </div>
      {renderPlasmicSlot({
